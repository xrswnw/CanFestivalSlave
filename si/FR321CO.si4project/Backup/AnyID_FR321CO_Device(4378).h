...
//canopen相关--------------------------------------------------------------
#define CANOPEN_MAPOB_NUM    8   
#define CANOPEN_PDO_NUM      4

#define CANOPEN_TPDO_COM_PARAMS_NUM  6
#define CANOPEN_RPDO_COM_PARAMS_NUM  8
...
#define CANOPEN_TRANSIONTYPE_ACYCLIC_SYNCHRONIZATION    0x00        //非循环同步
#define CANOPEN_TRANSIONTYPE_LOOP_SYNCHRONIZATION_1     0x01        //循环同步一次
#define CANOPEN_TRANSIONTYPE_REMOTE_SYNCHRONIZATION   0x01        //循环同步一次
