...
const u8 DEVICE_VERSION[DEVICE_VERSION_SIZE]@0x08005000 = "FR321CO 24031402 G231200";
...
void Device_ResetDeviceParamenter()
{
	...
	g_sDeviceParams.canOpneParams.rPdoParams[CANOPEN_POD_INDEX_0].comParams.transmissionType = CANOPEN_PDO_TRANSIONTYPE_ACYCLIC_SYNCHRONIZATION;
	...
	g_sDeviceParams.canOpneParams.rPdoParams[CANOPEN_POD_INDEX_1].comParams.transmissionType = CANOPEN_PDO_TRANSIONTYPE_ACYCLIC_SYNCHRONIZATION;
	...
	g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_3].comParams.cobId = 0x380;
...
u32 Device_CanFestivalCallBackInit(void)				//回调函数注册
{
	...
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1400, 0x01, index0x1400_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1400, 0x02, index0x1400_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1400, 0x03, index0x1400_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1400, 0x04, index0x1400_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1400, 0x05, index0x1400_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1400, 0x06, index0x1400_0x06_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1401, 0x01, index0x1401_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1401, 0x02, index0x1401_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1401, 0x03, index0x1401_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1401, 0x04, index0x1401_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1401, 0x05, index0x1401_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1401, 0x06, index0x1401_0x06_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1402, 0x01, index0x1402_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1402, 0x02, index0x1402_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1402, 0x03, index0x1402_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1402, 0x04, index0x1402_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1402, 0x05, index0x1402_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1402, 0x06, index0x1402_0x06_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1403, 0x01, index0x1403_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1403, 0x02, index0x1403_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1403, 0x03, index0x1403_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1403, 0x04, index0x1403_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1403, 0x05, index0x1403_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1403, 0x06, index0x1403_0x06_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1600, 0x00, index0x1600_0x00_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1600, 0x01, index0x1600_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1600, 0x02, index0x1600_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1600, 0x03, index0x1600_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1600, 0x04, index0x1600_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1600, 0x05, index0x1600_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1600, 0x06, index0x1600_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1600, 0x07, index0x1600_0x07_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1601, 0x00, index0x1601_0x00_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1601, 0x01, index0x1601_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1601, 0x02, index0x1601_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1601, 0x03, index0x1601_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1601, 0x04, index0x1601_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1601, 0x05, index0x1601_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1601, 0x06, index0x1601_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1601, 0x07, index0x1601_0x07_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1602, 0x00, index0x1602_0x00_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1602, 0x01, index0x1602_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1602, 0x02, index0x1602_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1602, 0x03, index0x1602_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1602, 0x04, index0x1602_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1602, 0x05, index0x1602_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1602, 0x06, index0x1602_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1602, 0x07, index0x1602_0x07_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1603, 0x00, index0x1603_0x00_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1603, 0x01, index0x1603_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1603, 0x02, index0x1603_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1603, 0x03, index0x1603_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1603, 0x04, index0x1603_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1603, 0x05, index0x1603_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1603, 0x06, index0x1603_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1603, 0x07, index0x1603_0x07_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1800, 0x01, index0x1800_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1800, 0x02, index0x1800_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1800, 0x03, index0x1800_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1800, 0x04, index0x1800_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1800, 0x05, index0x1800_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1800, 0x06, index0x1800_0x06_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1801, 0x01, index0x1801_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1801, 0x02, index0x1801_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1801, 0x03, index0x1801_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1801, 0x04, index0x1801_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1801, 0x05, index0x1801_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1801, 0x06, index0x1801_0x06_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1802, 0x01, index0x1802_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1802, 0x02, index0x1802_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1802, 0x03, index0x1802_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1802, 0x04, index0x1802_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1802, 0x05, index0x1802_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1802, 0x06, index0x1802_0x06_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1803, 0x01, index0x1803_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1803, 0x02, index0x1803_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1803, 0x03, index0x1803_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1803, 0x04, index0x1803_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1803, 0x05, index0x1803_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1803, 0x06, index0x1803_0x06_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A00, 0x00, index0x1A00_0x00_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A00, 0x01, index0x1A00_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A00, 0x02, index0x1A00_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A00, 0x03, index0x1A00_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A00, 0x04, index0x1A00_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A00, 0x05, index0x1A00_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A00, 0x06, index0x1A00_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A00, 0x07, index0x1A00_0x07_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A01, 0x00, index0x1A01_0x00_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A01, 0x01, index0x1A01_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A01, 0x02, index0x1A01_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A01, 0x03, index0x1A01_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A01, 0x04, index0x1A01_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A01, 0x05, index0x1A01_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A01, 0x06, index0x1A01_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A01, 0x07, index0x1A01_0x07_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A02, 0x00, index0x1A02_0x00_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A02, 0x01, index0x1A02_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A02, 0x02, index0x1A02_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A02, 0x03, index0x1A02_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A02, 0x04, index0x1A02_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A02, 0x05, index0x1A02_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A02, 0x06, index0x1A02_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A02, 0x07, index0x1A02_0x07_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A03, 0x00, index0x1A03_0x00_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A03, 0x01, index0x1A03_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A03, 0x02, index0x1A03_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A03, 0x03, index0x1A03_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A03, 0x04, index0x1A03_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A03, 0x05, index0x1A03_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A03, 0x06, index0x1A03_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x1A03, 0x07, index0x1A03_0x07_callback);


	
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2000, 0x01, index0x2000_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2000, 0x02, index0x2000_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2000, 0x03, index0x2000_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2000, 0x04, index0x2000_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2000, 0x05, index0x2000_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2000, 0x06, index0x2000_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2000, 0x07, index0x2000_0x07_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2000, 0x08, index0x2000_0x08_callback);
	
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2001, 0x01, index0x2001_0x01_callback);		
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2001, 0x02, index0x2001_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2001, 0x03, index0x2001_0x03_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2001, 0x04, index0x2001_0x04_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2001, 0x05, index0x2001_0x05_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2001, 0x06, index0x2001_0x06_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2001, 0x07, index0x2001_0x07_callback);
	
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2002, 0x02, index0x2002_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2002, 0x04, index0x2002_0x04_callback);

	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2100, 0x02, index0x2100_0x02_callback);
	errorCode = RegisterSetODentryCallBack(&AnyId_FR321CO_Slave_Data, 0x2100, 0x04, index0x2100_0x04_callback);
	return errorCode;
}
...
{
	Device_ParamsUpdata(HardParams_DeviceAddr, g_sDeviceParams.addr);
	Device_ParamsUpdata(HardParams_Bud, g_sDeviceParams.bud);
	Device_ParamsUpdata(HardParams_CanFilterMode, g_sDeviceParams.canFilterPara.CAN_FilterMode);
	Device_ParamsUpdata(HardParams_CanFilterIdLow, g_sDeviceParams.canFilterPara.CAN_FilterIdLow);
	Device_ParamsUpdata(HardParams_CanFilterIdHigh, g_sDeviceParams.canFilterPara.CAN_FilterIdHigh);
	Device_ParamsUpdata(HardParams_DeviceAddr, g_sDeviceParams.addr);
	Device_ParamsUpdata(HardParams_CanFilterMaskIdLow, g_sDeviceParams.canFilterPara.CAN_FilterMaskIdLow);
	Device_ParamsUpdata(HardParams_CanFilterMaskIdHigh, g_sDeviceParams.canFilterPara.CAN_FilterMaskIdHigh);
	Device_ParamsUpdata(HardParams_RfidRfu, g_sDeviceParams.rfu);
	
	Device_ParamsUpdata(RfidParams_Protocol, g_sDeviceParams.rfParams.protocol);
	Device_ParamsUpdata(RfidParams_RBlkNum, g_sDeviceParams.rfParams.rBlkNum);
	Device_ParamsUpdata(RfidParams_AutoAddr, g_sDeviceParams.autoBlockParams.addr);
	Device_ParamsUpdata(RfidParams_AutoLen, g_sDeviceParams.autoBlockParams.len);
	Device_ParamsUpdata(RfidParams_InvtTim, g_sDeviceParams.workTim.invtTim);
	Device_ParamsUpdata(RfidParams_IdleTim, g_sDeviceParams.workTim.idleTim);
	Device_ParamsUpdata(RfidParams_KeepTim, g_sDeviceParams.workTim.keepTim);
	Device_ParamsUpdata(RfidParams_RfidRfu, g_sDeviceParams.rfParams.rfu);
