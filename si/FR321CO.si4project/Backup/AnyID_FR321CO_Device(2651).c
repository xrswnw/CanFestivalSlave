...
const u8 DEVICE_VERSION[DEVICE_VERSION_SIZE]@0x08005000 = "FR321CO 24042000 G231200";
...
{
	//	可优化，无需这么高频率，或者时间产生再判断
	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_0].comParams.transmissionType, AnyId_FR321CO_Slave_obj1800_Transmission_Type, Device_WriteDeviceParamenter());
	...
	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_1].comParams.transmissionType, AnyId_FR321CO_Slave_obj1800_Transmission_Type);
	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_1].comParams.compatibilityEntry, AnyId_FR321CO_Slave_obj1800_Compatibility_Entry);
	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_1].comParams.eventTimer, AnyId_FR321CO_Slave_obj1800_Event_Timer);

	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_2].comParams.transmissionType, AnyId_FR321CO_Slave_obj1800_Transmission_Type);
	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_2].comParams.compatibilityEntry, AnyId_FR321CO_Slave_obj1800_Compatibility_Entry);
	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_2].comParams.eventTimer, AnyId_FR321CO_Slave_obj1800_Event_Timer);

	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_3].comParams.transmissionType, AnyId_FR321CO_Slave_obj1800_Transmission_Type);
	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_3].comParams.compatibilityEntry, AnyId_FR321CO_Slave_obj1800_Compatibility_Entry);
	Device_ParamsUpdataSave(g_sDeviceParams.canOpneParams.tPdoParams[CANOPEN_POD_INDEX_3].comParams.eventTimer, AnyId_FR321CO_Slave_obj1800_Event_Timer);
