...
void Device_Init()
{
	...
	memcpy(AnyId_FR321CO_Slave_obj1008, (u8 *)&DEVICE_VERSION[DEVICE_VERSION_DEVICE_NAME_POS], DEVICE_VERSION_DEVICE_NAME_LEN);
	memcpy(AnyId_FR321CO_Slave_obj1009, (u8 *)&DEVICE_VERSION[DEVICE_VERSION_DEVICE_HARDWARE_POS], DEVICE_VERSION_DEVICE_SOFTWARE_LEN);
	memcpy(AnyId_FR321CO_Slave_obj100A, (u8 *)&DEVICE_VERSION[DEVICE_VERSION_DEVICE_SOFTWARE_POS], DEVICE_VERSION_DEVICE_HARDWARE_LEN);
}
...
AnyId_FR321CO_Slave_highestSubIndex_obj1400; /* number of subindex - 1*/
AnyId_FR321CO_Slave_obj1400_COB_ID_used_by_PDO;	/* 512 */
AnyId_FR321CO_Slave_obj1400_Transmission_Type;	/* 0 */
AnyId_FR321CO_Slave_obj1400_Inhibit_Time;	/* 0 */
AnyId_FR321CO_Slave_obj1400_Compatibility_Entry; /* 0 */
AnyId_FR321CO_Slave_obj1400_Event_Timer;	/* 0 */
AnyId_FR321CO_Slave_obj1400_SYNC_start_value;	/* 0 */


AnyId_FR321CO_Slave_highestSubIndex_obj1600; /* number of subindex - 1*/
AnyId_FR321CO_Slave_obj1600[];

//

AnyId_FR321CO_Slave_highestSubIndex_obj1401; /* number of subindex - 1*/
AnyId_FR321CO_Slave_obj1401_COB_ID_used_by_PDO;	/* 768 */
AnyId_FR321CO_Slave_obj1401_Transmission_Type;	/* 0 */
AnyId_FR321CO_Slave_obj1401_Inhibit_Time;	/* 0 */
AnyId_FR321CO_Slave_obj1401_Compatibility_Entry; /* 0 */
AnyId_FR321CO_Slave_obj1401_Event_Timer;	/* 0 */
AnyId_FR321CO_Slave_obj1401_SYNC_start_value;	/* 0 */


AnyId_FR321CO_Slave_highestSubIndex_obj1601; /* number of subindex - 1*/
AnyId_FR321CO_Slave_obj1601[];


AnyId_FR321CO_Slave_highestSubIndex_obj1402; /* number of subindex - 1*/
AnyId_FR321CO_Slave_obj1402_COB_ID_used_by_PDO;	/* 1024 */
AnyId_FR321CO_Slave_obj1402_Transmission_Type;	/* 0 */
AnyId_FR321CO_Slave_obj1402_Inhibit_Time;	/* 0 */
AnyId_FR321CO_Slave_obj1402_Compatibility_Entry; /* 0 */
AnyId_FR321CO_Slave_obj1402_Event_Timer;	/* 0 */
AnyId_FR321CO_Slave_obj1402_SYNC_start_value;	/* 0 */


AnyId_FR321CO_Slave_highestSubIndex_obj1602; /* number of subindex - 1*/
AnyId_FR321CO_Slave_obj1602[];


AnyId_FR321CO_Slave_highestSubIndex_obj1403; /* number of subindex - 1*/
AnyId_FR321CO_Slave_obj1403_COB_ID_used_by_PDO;	/* 1280 */
AnyId_FR321CO_Slave_obj1403_Transmission_Type;	/* 0 */
AnyId_FR321CO_Slave_obj1403_Inhibit_Time;	/* 0 */
AnyId_FR321CO_Slave_obj1403_Compatibility_Entry; /* 0 */
AnyId_FR321CO_Slave_obj1403_Event_Timer;	/* 0 */
AnyId_FR321CO_Slave_obj1403_SYNC_start_value;	/* 0 */



AnyId_FR321CO_Slave_highestSubIndex_obj1603; /* number of subindex - 1*/
AnyId_FR321CO_Slave_obj1603[];
